...
def send_home_assistant_notification(message: str, media_id: str, entity_id: str):
    """Send a notification via the Home Assistant webhook."""
    try:
        response = requests.post(HOME_ASSISTANT_WEBHOOK_URL, json={"message": message, "media_id": media_id, "entity_id": entity_id})
